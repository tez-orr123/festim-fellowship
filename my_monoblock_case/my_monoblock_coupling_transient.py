...
# Just a H transport Problem, no longer discontinuous?
# So a lot later on with the interface definitions will need
# to be edited with this change in problem definition
...
# that was IT???? my densities were just mega black hole high haha
...
# Yes!! This is transient and couples temperature gradient and hydrogen transport

# Increasing time to be 3.2e7, need an adaptive stepsize
# works and is much quicker than before!

# Could ask Remi and James on Monday, is this the most efficient method ??
# OR am I really over-engineering a temperature gradient
